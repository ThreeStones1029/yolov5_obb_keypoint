...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default="runs/train/rotate/weights/best.pt", help='model.pt path(s)')
    ...
    parser.add_argument('--name', default='rotate_val', help='save to project/name')
