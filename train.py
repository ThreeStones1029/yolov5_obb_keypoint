...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default="runs/yolov5n/train/buu/weights/best.pt", help='initial weights path')
    ...
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/obb/hyp_xray20241203.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/yolov5n/train', help='save to project/name')
    parser.add_argument('--name', default='xray20241203_semantic_buu_pretrain', help='save to project/name')
