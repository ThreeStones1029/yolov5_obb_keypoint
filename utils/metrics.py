...
def fitness_with_points(x):
    # Model fitness as a weighted combination of metrics
    w = [0.0, 0.0, 0.1, 0.8, 0.0, 0.1]  # weights for [P, R, mAP@0.5, mAP@0.5:0.95, pdmAP@50, pdmAP@10:50]
    return (x[:, :6] * w).sum(1)
...
def pd_ap_per_class(tp, conf, pred_cls, target_cls,names=(), eps=1e-16):
    """
